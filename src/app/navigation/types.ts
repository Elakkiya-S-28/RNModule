...
/**
 * Centralised navigation param lists.
 * Screen names are namespaced by module to keep the three modules decoupled.
 */
...
/** A small helper to navigate with a stack param list type guard. */
